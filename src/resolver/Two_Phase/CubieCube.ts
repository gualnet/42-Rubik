...
import * as cubeInterfaces from './interfaces';

const Corners: cubeInterfaces.ICorners = {
...
const Edges: cubeInterfaces.IEdges = {
...
class CubieCube {
  corners: cubeInterfaces.ICorners;
  edges: cubeInterfaces.IEdges;

  constructor(corners: cubeInterfaces.ICorners, edges: cubeInterfaces.IEdges) {
